...
export class ListaUsuariosComponent implements OnInit {
  //aqui creamos un arreglo vamos a crear un arreglo tipado que contendrá
  ...
  ngOnInit(): void {
    this.totalUsuarios = this.totalUsuariosTotal();
  ...
  totalUsuariosFemeninos(): number {
    return this.listaUsuarios.filter((usuario) => usuario.genero === 'F')
      .length;
  }
  totalUsuariosMasculinos(): number {
    return this.listaUsuarios.filter((usuario) => usuario.genero === 'M')
      .length;
  }
  totalUsuariosTotal(): number {
